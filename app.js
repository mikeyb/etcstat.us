...
if( process.env.NODE_ENV !== 'production' )
{
    ...
    server = https.createServer({
        key: fs.readFileSync("/etc/letsencrypt/live/etcstat.us/privkey.pem"),
        cert: fs.readFileSync("/etc/letsencrypt/live/etcstat.us/fullchain.pem"),
        ca: fs.readFileSync("/etc/letsencrypt/live/etcstat.us/chain.pem")
    }, app);
}
// Init socket vars
